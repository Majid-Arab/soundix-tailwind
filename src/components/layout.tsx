        ...
        <div className="bg-white p-4 shadow rounded">
          ...
          <div className="flex space-x-4">
            ...
            <div className="flex flex-col">
              <p>Ergonomics on point. Up to 22 hours of listening time. Apple W1 Chip & Wireless Bluetooth.</p>
              <p className="text-xl font-bold">$359.95</p>
              <button className="mt-2 p-2 bg-blue-500 text-white rounded">Add to cart</button>
              <button className="mt-2 p-2 bg-green-500 text-white rounded">Buy now</button>
            </div>
          </div>
        </div>
