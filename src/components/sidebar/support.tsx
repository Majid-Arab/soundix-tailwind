...
function Support() {
  return (
    <div className="flex justify-center items-center max-w-72">
      <div className="flex justify-around items-center flex-col gap-2 p-4 m-5 bg-[#A1D2FF] text-[#047979] rounded-2xl">
        ...
        <button
          type="button"
          className="border-white border-2 relative rounded-lg px-4 py-2 bg-[#EBFCFF] text-[#047979] text-sm font-semibold hover:border-2 hover:border-[#047979]  focus:outline-none focus:ring-2 focus:ring-[#047979] focus:ring-offset-2"
        >
          Customer Service
        </button>
      </div>
